...
public:
	...
	virtual RaceCooker GetRace() {return Race;}; //{return Race;}
...
class Mousee: public ActionOfCooker
{
private:
	bool VacSleep;
	bool Cooking;
...
public:
	int Skill;
	Mousee(Cooker type, RaceCooker race, bool colorOfClothes, bool wearingGlasses): ActionOfCooker()
    {
        Type=type; Race = race;
	...
	Cooker GetCooker() const {return Cooker::Mousee;}
};
...
private:
	...
	list<CookerPtr>::const_iterator iter;
...
public:
	...
	void Next() { iter++; }
	bool IsDone() const { return iter == CookerBox->end(); }
...
{
public:
	virtual void AddCooker(CookerPtr newCooker) = 0;
	virtual int GetCount() const = 0;
	virtual Iterator<CookerPtr> *GetIterator() = 0;
};

typedef BaseContainer *ContPtr;

class CookerContainer : public BaseContainer
{
private:
	CookerPtr *CookerBox;
	int CookerCount;
...
class CookerContainerV2 : public BaseContainer // контейнер номер 2
{
private:
...
class CookerBD : public BaseContainer
{
private:
	sqlite3 *CookerBox;
